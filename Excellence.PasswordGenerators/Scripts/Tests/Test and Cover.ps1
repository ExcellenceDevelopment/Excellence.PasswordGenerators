...
dotnet dotcover test $solutionFilePath --configuration=$configuration --framework=$framework --dcReportType="DetailedXML" --dcOutput=$testCoverageFilePath --dcFilters=-:Excellence.Randomizers;
